...
if __name__=="__main__":
    ...
    dst = np.float32([[640 - maxWidth / 4, (img.shape[0] - maxWidth) / 2 + 300],
                      [640 + maxWidth / 4, (img.shape[0] - maxWidth) / 2 + 300],
                      [640 - maxWidth / 4, (img.shape[0]) / 2 + 300],
                      [640 + maxWidth / 4, (img.shape[0]) / 2 + 300]])

    M = cv2.getPerspectiveTransform(scr, dst)
    np.savez('BirdRot', BirdRot=M)
